		...
		<nav className="navbar navbar-light bg-text-primary">
			<div>
				...
				<div className="btn-group d-block-sm d-inline-md d-inline-lg btn-two">
					...
					:	<button className="btn btn-primary dropdown-toggle middle-button" id="btn-two" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				...
				<div className="btn-group d-block-sm d-inline-md d-inline-lg btn-three">
					...
					: <button className="btn btn-primary dropdown-toggle" id="btn-three" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							Exemption By Reason
						</button>
					}
