			...
			<div>
				<div className="btn-group d-block-sm d-inline-md d-inline-lg btn-one">
					...
					<div className="dropdown-menu">
						<NavLink className="dropdown-item" target="_self" to="/school/complete_for_all">100% Immunization Rate</NavLink>
						<div className="dropdown-divider"></div>
						<NavLink className="dropdown-item" target="_self" to="/school/reported_yes">Reported Yes</NavLink>
						<div className="dropdown-divider"></div>
						<NavLink className="dropdown-item" target="_self" to="/school/reported_no">Reported No</NavLink>
						<div className="dropdown-divider"></div>
						<NavLink className="dropdown-item" target="_self" to="/school/all">All Schools</NavLink>
					</div>
				</div>
