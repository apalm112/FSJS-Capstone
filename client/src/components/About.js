...
const About = (props) => {
    return (
      <div className="about-container">
        ...
        <br/>
        <p className="about about-source">Source:<a href="https://data.wa.gov/Health/All-students-kindergarten-through-12th-grade-immun/9zru-c2kz">Data.WA.gov</a>
        </p>
        <p className="about about-data"> "About the Data:</p>
        <p className="about about-last">
        This data is based on counts of students by immunization status in all grades(kindergartner through 12 th grade) in public and private schools.The student immunization status is based on parent reports to schools and may not be verified by a healthcare provider.The department makes no other claims about the accuracy of the data as reported by schools.The summary data in this report is not weighted and does not account
